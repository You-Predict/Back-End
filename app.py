...
def clean_text(text):
    ...
    """
    # removes all words that contains numbers
...
def links_email_remover(text):
    ...
    """
    # remove links with protocol, e.g. http//google.com -
    text = re.sub(r"http\S+", "", text) 
    # remove links without protocol, e.g. facebook.com
...
def stopwords_remover(text):
    ...
    # remove words less than 4 character
